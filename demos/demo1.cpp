//----------------------------------------------------------------------------
// Demo1 - Isosurfaces with Marching Cubes
//----------------------------------------------------------------------------
...
protected:
    ...
    void createMesh_MC(Isosurface *iso, ThreeD::Vector voxelSize);
};
...
bool Demo1::initDemo()
{
    ...
    createMesh_MC(sphereIso, SPHERE_VOXEL_SIZE);
    ...
    createMesh_MC(boxIso, BOX_VOXEL_SIZE);
    ...
    createMesh_MC(box2Iso, BOX_VOXEL_SIZE);

    return true;
}


void Demo1::createMesh_MC(Isosurface *iso, ThreeD::Vector voxelSize)
{
    IsoMesher_MC mesher(iso);
